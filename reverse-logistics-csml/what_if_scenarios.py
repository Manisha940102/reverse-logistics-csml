...
ARTIFACTS_DIR = os.path.join(BASE_DIR, 'ml-service', 'model_artifacts')

if not os.path.exists(ARTIFACTS_DIR):
    alt_dir = os.path.join(BASE_DIR, 'data pipeline', 'Step 9 - Final Evaluation & Financial Impact (ROI)', 'pipeline_artifacts')
